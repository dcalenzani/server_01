...
class ResultsView(generic.DetailView):
    model = Question
    template_name = 'formulario/results.html'
...
def vote(request, question_id):
    ...
    try:
        ...
        return HttpResponseRedirect(reverse('formulario:results', args=(question.id,)))

def results(request, question_id):
    question = get_object_or_404(Question, pk=question_id)
    return render(request, 'formulario/results.html', {'question': question})