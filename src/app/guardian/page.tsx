const App = () => {
    return(
        <div className="m-5 [&>h2]:text-md [&>h2]:mt-5 [&>h2]:mb-5 [&>h2]:font-bold [&>p]:text-justify [&>p]:mt-7">
        <h1>PARA EL GUARDIAN</h1>
        ...
        <th className="text-center">Tiempo(aprox)</th>
        <th className="text-left">Descripcion</th>
        </tr>
        </thead>
        <tbody>
        <tr>
        <td className="text-left">Diseño y Mecánicas</td>
        <td className="text-center">30 minutos</td>
        <td className="text-left">Se explica a los jugadores la mecánica de pérdida de memoria. Deben construir su caja de recuerdos mientras les explicamos las mecánicas de Call of Cthulhu y definen a sus personajes.</td>
        </tr>
        <tr>
        <td className="text-left">Presentación de los personajes</td>
        <td className="text-center">10 minutos</td>
        <td className="text-left">Planteamos que los personajes, en el teatro de la mente, hablen a una cámara de video y presenten los contenidos de la caja de recuerdos, estos videos estarán disponibles en el comando de la nave de rescate como arraigo a la realidad.</td>
        </tr>
        <tr>
        <td className="text-left">Introducción del viaje</td>
        <td className="text-center">5 minutos</td>
        <td className="text-left">Describimos la llegada al cinturon de asteroides. Primer impacto del color sobre los investigadores al observar la magnitud del cinturon de asteroides y el tamaño de SCB03.</td>
        </tr>
        <tr>
        <td className="text-left">Primer combate</td>
        <td className="text-center">30 minutos</td>
        <td className="text-left">Horror humano, pelea con 4 soldados chipriotas, posible pérdida de vidas humanas entre los 6 soldados de acompañamiento.</td>
        </tr>
        <tr>
        <td className="text-left">Conversacion con refugiados</td>
        <td className="text-center">15 minutos</td>
        <td className="text-left">Situación general y no confidencial de la nave. Los refugiados piden ayuda pero prefieren no compartir información de la nave. Pueden ser dificilmente convencidos y facilmente intimidados, pero no pueden abrir la puerta sin la restauración del sistema</td>
        </tr>
        <tr>
        <td className="text-left">Camino al puente secundario</td>
        <td className="text-center">50 minutos</td>
        <td className="text-left">Recoleccion de pistas, se observan algunos cadaveres y gente viva en y fuera de la luz. Reciben disparos a lo lejos y si responden entonces los soldados enemigos huyen hacia el puente secundario.</td>
        </tr>
        <tr>
        <td className="text-left">Restauración del sistema y rescate de Pablo</td>
        <td className="text-center">30 minutos</td>
        <td className="text-left">Encuentro con el npc realmente afectado por el color. Pablo insistira en rescatar al domo</td>
        </tr>
        <tr>
        <td className="text-left">Emergencia final</td>
        <td className="text-center">20 minutos</td>
        <td className="text-left">Tormenta de luz final, provocando la transformacion total de todo lo que toca. Pablo insistira en abrir el domo, incrementando al maximo la exposicion a la luz</td>
        </tr>
        <tr>
        <td className="text-left">Final boss</td>
        <td className="text-center">20 minutos</td>
        <td className="text-left">Pelea con Pablo o con Pablo y la amalgama. Si la amalgama es enfrentada por si sola entonces es una victoria que simplemente sera narrada sin lanzar dados de combate (si de cordura)</td>
        </tr>
        <tr>
        <td className="text-left">Cierre</td>
        <td className="text-center">10 minutos</td>
        <td className="text-left">Desactivacion de la sesion, comentarios finales y explicaciones fuera de rol</td>
        </tr>
        </tbody>
        </table>
        <h2>Narracion</h2>
        ...
        <p>El otro grupo de soldados se encuentra en el 2do puente de control, resguardan a Pablo, el NPC, mientras que intentan hackear la computadora de mando para restaurar los sistemas.</p>
        ...
        <p>1 hora antes de finalizar la partida, Pablo desaparece y se escabulle hacia la bahia de ingenieria, desde donde sabotea los motores de la nave para alinearse con las donas, desencadenando la emergencia final y el cierre del one-shot.</p>
        <h2>POSIBLES CONCLUSIONES</h2>
        <ul>
        <li>Muere Pablo pero no logra afectar los motores. El puente no sobrevive. Es posible mover a Santa Cruz Bolivar del cinturon de asteroides despues de asesinar a la amalgama de sobrevivientes</li>
        <li>Muere Pablo pero afecta los motores, no es posible mover a Santa Cruz Bolivar del cinturon de Asteroides.</li>
        ...
        <h3>IDEAPAD</h3>
        <ul>
        <li>Organismo parasitario en un NPC que trata de llevarlos al domo de control. Pablo Figaro, cabo que lleva en la misión 1 año. Como persona no sabe nada de los experimentos que se llevan a cabo en SCB03,</li>
