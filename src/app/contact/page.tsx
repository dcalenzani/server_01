...
export default function ContactForm() {
  ...
  return (
    <main className="flex flex-col bg-zinc-300 dark:bg-zinc-950 h-screen w-screen text-inherit place-items-center justify-center dark:text-slate-50 p-0">
      <Hamburguer/>
      <DarkModeToggle></DarkModeToggle>
      <h1 className='text-4xl dark:text-slate-50'>Contact Me</h1>
      <div id="form and prompt" className='flex flex-row  md:justify-center md:space-x-10 right-1 pt-10'>
