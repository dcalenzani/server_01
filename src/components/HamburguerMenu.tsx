...
const Hamburguer: React.FC = () => {
    ...
    <>
        <div className="fixed z-50 bottom-0 flex h-28 w-full items-center justify-center pt-8 bg-gradient-to-t from-white via-white  overflow-hidden dark:from-black dark:via-black">
            <a
