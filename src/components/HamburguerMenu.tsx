...
const Hamburguer: React.FC<HamburguerProps> = ({ children }) => {
    ...
    <><div className="fixed z-50 bottom-0 left-108 flex h-48 w-full items-center justify-center pt-8 bg-gradient-to-t from-white via-white  overflow-hidden dark:from-black dark:via-black">
            <a
            ...
            <a href="javascript:void(0);" onClick={toggleMenu} className="text-3xl z-20 cursor-pointer mx-2 md:hidden block">
                <p>&#9776;</p>
            </a>
