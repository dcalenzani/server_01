...
const TableOfContents = () => {
  ...
  return (
    ...
    <DarkModeToggle/>
    <div className={`fixed flex flex-col font-open-dislexic rounded-md h-full max-h-full overflow-y-auto top-0 right-0 text-xl text-left w-screen pt-4 space-y-4 pb-[6rem] bg-gray-200 text-zinc-950 dark:text-gray-200 dark:bg-zinc-800 z-20 md:flex md:flex-col md:w-1/4 ${isMenuOpen ? 'block' : 'hidden'}`}>
